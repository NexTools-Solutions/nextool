            ...
            <?php else: ?>
               <?php
                  ...
                  foreach ($modulesState as $m) {
                     ...
                     $cat = $m['category'] ?? '';
                     if ($cat !== '') { $categoryCounters[$cat] = ($categoryCounters[$cat] ?? 0) + 1; }
                  }
               ...
               <div class="mb-3" id="nextool-module-filter-bar">
                  <div class="input-group mb-2">
                     ...
                     <input type="text" class="form-control border-start-0" id="nextool-module-search" placeholder="<?php echo __('Buscar módulo por nome ou descrição...', 'nextool'); ?>" autocomplete="off">
                  </div>
               ...
               <div class="row g-3">
                  <?php foreach ($modulesState as $module):
                     ...
                     if ($tier === 'DEV') {
                        $borderClass = 'nextool-border-dev'; $tierColor = 'nextool-color-dev';
                     } elseif ($module['is_paid']) {
                        $borderClass = 'nextool-border-paid'; $tierColor = 'nextool-color-paid';
                     } else {
                        $borderClass = 'nextool-border-free'; $tierColor = 'nextool-color-free';
                     }
                  ...
                  <div class="col-md-6 nextool-module-card"
                     ...
                     <div class="card border <?php echo $borderClass; ?> h-100 position-relative">
                        ...
                        <div class="card-body d-flex flex-column">
                           <div class="d-flex align-items-start gap-2 mb-2">
                              ...
                              <div class="flex-grow-1" style="min-width: 0;">
                                 ...
                                 <?php
                                    ...
                                    $versionLabel = $installedVersion ? 'v' . $installedVersion : ($availableVersion ? 'v' . $availableVersion : '');
                                 ?>
                           ...
                           <div class="mb-2"><span class="badge text-white bg-secondary"><?php echo __('Indisponível', 'nextool'); ?></span></div>
                           <?php endif; ?>
