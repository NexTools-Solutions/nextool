   ...
   <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <button type="button" class="btn btn-outline-secondary" data-dismiss="modal"><?php echo __('Cancelar', 'nextool'); ?></button>
...
function nextoolInitModuleActions() {
   ...
   document.addEventListener('click', function (event) {
      ...
      // Ação de licenciamento: abre modal Stripe em vez de executar via AJAX
      if (action === 'licensing') {
