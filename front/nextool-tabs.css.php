 ...
 * -------------------------------------------------------------------------
 * Servido via PHP (e nao .css estatico) para manter o MESMO padrao do GLPI 11,
 * onde o Symfony NAO serve .css estatico de plugin por path direto. Mesmo padrao
 * dos modulos (front/module_assets.php + *.css.php). CSS publico, sem dados
 * sensiveis e sem input do usuario -> nao exige sessao.
 *
