...
- <a href="https://github.com/NexTools-Solutions/nextool/releases/tag/v4.0.2" target="_blank" rel="noopener"><strong>GLPI 11</strong>: branch <code>main</code> (código e releases próprios)</a>
