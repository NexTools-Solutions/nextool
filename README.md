...
- <a href="https://github.com/NexTools-Solutions/nextool/releases/tag/v5.0.6" target="_blank" rel="noopener"><strong>GLPI 11</strong>: branch <code>main</code> (esta linha)</a>
- <a href="https://github.com/NexTools-Solutions/nextool/releases/tag/v5.0.5-glpi10" target="_blank" rel="noopener"><strong>GLPI 10</strong>: branch <code>glpi-10</code> (código e releases próprios)</a>
